    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="createModalLabel">Agregar cliente</h4>
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input wire:model="customerName" id="customerName" type="text" class="form-control" placeholder="Nombre">@error('customerName') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                </form>
            </div>
